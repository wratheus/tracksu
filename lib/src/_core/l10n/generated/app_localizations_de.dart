...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get settingsCacheCalculating => 'Cachegröße wird berechnet…';

  @override
  String get settingsCacheFailed =>
      'Kein Zugriff auf den Cache. Bitte erneut versuchen.';
  ...
  @override
  String get teamLoading => 'Team wird geladen…';

  @override
  String get teamNotFound => 'Team nicht gefunden';

  @override
  String get teamAccessDenied => 'Dieses Team kann nicht angezeigt werden.';

  @override
  String get teamFailed =>
      'Team konnte nicht geladen werden. Versuche es erneut.';

  @override
  String get teamOpen => 'Rekrutierung offen';

  @override
  String get teamClosed => 'Rekrutierung geschlossen';
  ...
  String teamCreated(String date) {
    return 'Gegründet am $date';
  }

  @override
  String teamDefaultMode(String mode) {
    return 'Standardmodus: $mode';
  }

  @override
  String get teamDescription => 'Über das Team';

  @override
  String get teamLeader => 'Teamleitung';
  ...
  String get scoreGaugeReference =>
      'Referenzskala für osu!lazer-Genauigkeit; SS erfordert 100 % (der Bereich ist zur besseren Sichtbarkeit vergrößert). Der Rang stammt aus dem Ergebnis; Fehler, Mods und alte Wertungsregeln können ihn beeinflussen.';
  ...
  String get profileDailyEmpty =>
      'Dieser Spieler hat noch nicht an der täglichen Herausforderung teilgenommen.';
  ...
  String get aboutUnofficial =>
      'Ein unabhängiger, inoffizieller Client. Nicht mit ppy Pty Ltd verbunden oder von ihr unterstützt.';

  @override
  String get aboutBuild => 'Installierte Version';
  ...
  @override
  String get aboutProject => 'Projekt auf GitHub';
  ...
  @override
  String get spotlightsSearch => 'Name, Jahr oder ID';
  ...
  @override
  String get contentMediaSettings => 'Bilder laden';
  ...
  String get contentMediaDisabled =>
      'Bilder sind ausgeschaltet. In den Einstellungen aktivieren.';
  ...
  String get rankingsCountryCatalogHint =>
      'Nach Ländernamen oder zweistelligem Code suchen. Die Verfügbarkeit der Rangliste hängt von osu! ab.';
