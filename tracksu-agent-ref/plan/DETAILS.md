...
Уточнение порядка 2026-09-05: функциональный перенос legacy-страниц не ждёт
UI kit и темизации. Пока используем изолированные widgets и текущее временное
оформление; не придумываем новый визуальный стиль в ходе переноса API/Bloc.

P07 начинается отдельным планированием: после аудита assets (P01.2) согласовать
их допустимость и визуальную совместимость, аккуратную адаптацию osu!-стиля,
палитру, типографику, иконки и примеры ключевых экранов/состояний. Только после
явного согласования пользователем реализуем tokens/темы и необходимые
примитивы. Это не автоматическое разрешение копировать osu! assets или branding.
Kit расширяем по реальным потребностям перенесённых экранов.
...
- Решение пользователя 2026-09-10: при внедрении аналитики обязательно показать
  отдельное согласие до сбора. UX, отказ/Back, сохранение выбора/версии и отзыв
  через настройки — в [P01.3](work/P01.3-privacy-and-terms.md#отдельное-согласие-на-аналитику--требование-от-2026-09-10).
  Не объединять с разрешением картинок или OAuth; без согласия — no-op и
  выключенный автоматический SDK-сбор. Это gate P06.1, не отложенная доработка.
- До включения согласовать, что собирается и зачем, retention, рынки/consent,
  ...
  сбора и восстановление выбора пользователя; устойчивое хранение согласия
  подключить в P06.1 до включения сбора, не откладывать до P08.
...
- Порядок: P06.1 — клиент/adapter/registry/privacy policy и одна узкая привязка;
  включая UX согласия и сохранение выбора; P07 — одинаковые hooks UI kit;
  P08 — session events с уже действующим consent gate;
