...
Обновление после P12: карточки теперь открывают typed route; из mostPlayed —
конкретная сложность, из остальных категорий — набор. Текущий результат и
ручная проверка описаны в [P12](P12-beatmap.md).
