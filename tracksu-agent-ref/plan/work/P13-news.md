...
Исторический API-срез. Продуктовая доработка и актуальная media policy —
[P20](P20-news-product.md); старые описания text-only reader и APK gate ниже
не являются текущими инструкциями.
