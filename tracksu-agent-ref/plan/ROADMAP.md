...
| [P08](DETAILS.md#p08) | Auth/session и миграция secure storage | TokenStore, session restore, bearer, code exchange и persistent callback state готовы; refresh/logout/legacy migration и ручный flow остаются | in_progress |
