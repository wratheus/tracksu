...
| [P08](DETAILS.md#p08) | Auth/session и миграция secure storage | TokenStore, session restore, bearer и code exchange готовы; refresh/logout/legacy migration и ручный flow остаются | in_progress |
