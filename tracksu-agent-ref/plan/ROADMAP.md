...
2026-09-13 · единственная активная очередь. Сверена с кодом и историей Git.

## Сейчас

Последнее уточнение — [P24: команды, рейтинг и настройки](work/P24-teams-and-ranking-density.md).
Нативная Team-страница, плотные ranking rows с PP справа и независимый доступ
к настройкам реализованы; ожидают ручной проверки. Остаток P23 (аудио/cache)
сохраняется в очереди, не объявлен завершённым.
...
решение от 9 сентября: внешние картинки после одноразового разрешения,
с сохранением отказа и тумблером в настройках; реализация в P18.
