...
| [P08](DETAILS.md#p08) | Auth/session и миграция secure storage | TokenStore, session restore, bearer, code exchange, persistent callback state, refresh и one-shot 401 retry готовы; logout/legacy migration и ручный flow остаются | in_progress |
