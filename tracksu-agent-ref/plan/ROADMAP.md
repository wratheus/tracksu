...
карты дня подключены. Медали пока только ID/даты, иллюстрированный справочник
не закрыт. Далее — индикаторы сложностей, страница результата/шрифт,
метаданные медалей, Spotlights (media/карточки/selector) и новости.
