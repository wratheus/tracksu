...
раскрывающиеся блоки для профиля/новостей/описаний карт. Текущий текстовый
About — только baseline. Контракт описан, политика внешних media требует выбора.
Этот общий компонент берём перед rich-content интеграцией в карты; остальные
