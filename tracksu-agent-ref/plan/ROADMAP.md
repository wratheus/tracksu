...
| [P08](DETAILS.md#p08) | Auth/session и миграция secure storage | TokenStore, session restore, bearer, code exchange, persistent callback state и single-flight refresh готовы; 401 retry/logout/legacy migration и ручный flow остаются | in_progress |
