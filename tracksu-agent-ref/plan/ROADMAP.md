...
| [P07.1](DETAILS.md#p07-1) | Обязательная localization foundation | ARB/gen-l10n, en/ru delegates, system fallback, persisted locale controller и guest selector готовы; перенос следующих feature остаётся | in_progress |
