...
| 4 · [P11](work/P11-rankings.md) | PP/score × четыре режима подключены, cursor paging/refresh/retry и вход из shell. Ручная проверка; страны/variants/spotlights и переход в профиль остаются | in_progress |
