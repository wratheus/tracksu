...
Рейтинги, отдельные списки карт профиля, экран beatmap, новости и audio ещё
находятся в legacy-коде и не объявляются готовыми функциями нового shell.
Карточки scores пока не открывают отдельную карту (P12). Сначала восстанавливаем эти
