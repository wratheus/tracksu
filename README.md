...
- Кнопка рейтингов в верхней панели: PP/score для четырёх режимов,
  догрузка страниц, отдельные refresh/retry.

В рейтингах пока нет выбора страны, mania variants/spotlights и перехода
из строки к профилю — это оставшаяся часть P11.
